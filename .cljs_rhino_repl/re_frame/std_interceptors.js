...
var vec__43131_43134 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_43135 = cljs.core.nth.call(null,vec__43131_43134,(0),null);
var only_after_43136 = cljs.core.nth.call(null,vec__43131_43134,(1),null);
var db_changed_QMARK__43137 = (cljs.core.some_QMARK_.call(null,only_before_43135)) || (cljs.core.some_QMARK_.call(null,only_after_43136));
if(db_changed_QMARK__43137){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_43135);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_43136);
...
var map__43144 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__43144__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__43144__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__43152 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__43152__$1;
var event = cljs.core.get.call(null,map__43152__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__26162__auto___43155 = arguments.length;
var i__26163__auto___43156 = (0);
while(true){
if((i__26163__auto___43156 < len__26162__auto___43155)){
args__26169__auto__.push((arguments[i__26163__auto___43156]));

var G__43157 = (i__26163__auto___43156 + (1));
i__26163__auto___43156 = G__43157;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq43154){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43154));
});
...
var args__26169__auto__ = [];
var len__26162__auto___43163 = arguments.length;
var i__26163__auto___43164 = (0);
while(true){
if((i__26163__auto___43164 < len__26162__auto___43163)){
args__26169__auto__.push((arguments[i__26163__auto___43164]));

var G__43165 = (i__26163__auto___43164 + (1));
i__26163__auto___43164 = G__43165;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__43158_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__43159_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__43159_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq43160){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__43161,G__43162,seq43160__$2);
});
