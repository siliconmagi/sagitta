...
var G__43501 = o;
(G__43501[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__43503__i < G__43503__a.length) {G__43503__a[G__43503__i] = arguments[G__43503__i + 0]; ++G__43503__i;}
  args = new cljs.core.IndexedSeq(G__43503__a,0);
} 
...
var G__43510 = jsprops;
(G__43510["defaultValue"] = value);

(G__43510["onChange"] = ((function (G__43510,v,value,on_change){
return (function (p1__43507_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__43507_SHARP_);
});})(G__43510,v,value,on_change))
);

(G__43510["ref"] = ((function (G__43510,v,value,on_change){
return (function (p1__43508_SHARP_){
return (this$["cljsInputElement"] = p1__43508_SHARP_);
});})(G__43510,v,value,on_change))
);
...
var vec__43517 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__43517,(0),null);
var id = cljs.core.nth.call(null,vec__43517,(1),null);
var class$ = cljs.core.nth.call(null,vec__43517,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___43522 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___43522 == null)){
} else {
var key_43523 = temp__4661__auto___43522;
(jsprops["key"] = key_43523);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__43525 = (new reagent.impl.template.NativeWrapper());
(G__43525["name"] = c);
...
var len__26162__auto___43531 = arguments.length;
var i__26163__auto___43532 = (0);
while(true){
if((i__26163__auto___43532 < len__26162__auto___43531)){
args__26169__auto__.push((arguments[i__26163__auto___43532]));

var G__43533 = (i__26163__auto___43532 + (1));
i__26163__auto___43532 = G__43533;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq43529){
var G__43530 = cljs.core.first.call(null,seq43529);
var seq43529__$1 = cljs.core.next.call(null,seq43529);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__43530,seq43529__$1);
});
...
break;
default:
var G__43537 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__43537;
continue;
...
var n__26002__auto___43540 = a.length;
var i_43541 = (0);
while(true){
if((i_43541 < n__26002__auto___43540)){
(a[i_43541] = reagent.impl.template.as_element.call(null,(a[i_43541])));

var G__43542 = (i_43541 + (1));
i_43541 = G__43542;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26002__auto___43543 = a.length;
var i_43544 = (0);
while(true){
if((i_43544 < n__26002__auto___43543)){
var val_43545 = (a[i_43544]);
if((cljs.core.vector_QMARK_.call(null,val_43545)) && ((reagent.impl.template.key_from_vec.call(null,val_43545) == null))){
(o["no-key"] = true);
} else {
}

(a[i_43544] = reagent.impl.template.as_element.call(null,val_43545));

var G__43546 = (i_43544 + (1));
i_43544 = G__43546;
continue;
} else {
}
...
var ctx = ({});
var vec__43550 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__43550,(0),null);
var derefed = cljs.core.nth.call(null,vec__43550,(1),null);
...
var G__43554 = (cljs.core.count.call(null,argv) - first_child);
switch (G__43554) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__43554){
